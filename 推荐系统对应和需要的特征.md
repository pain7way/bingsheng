...
|  |   |
        ...
        `app_compass.baseinfo_goods`,`src_qianfan.wechat_mini_program_log`有5位数的券id,而src_qf_prod_coupon.coupon_stock，        src_qf_prod_coupon.coupon，src_qf_prod_coupon.coupon_store_rule没有
